...
mixin _$ThemeState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, themeId, isLoading, error);

  @override
  String toString() {
    return 'ThemeState(themeId: $themeId, isLoading: $isLoading, error: $error)';
  }
}
...
abstract mixin class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String themeId, bool isLoading, String? error});
}
...
extension ThemeStatePatterns on ThemeState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String themeId, bool isLoading, String? error)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ThemeState() when $default != null:
        return $default(_that.themeId, _that.isLoading, _that.error);
      case _:
        return orElse();
    }
  }
