...
mixin _$DeviceInfo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, model, osVersion);

  @override
  String toString() {
    return 'DeviceInfo(id: $id, model: $model, osVersion: $osVersion)';
  }
}
...
abstract mixin class $DeviceInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String? model, String? osVersion});
}
...
extension DeviceInfoPatterns on DeviceInfo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String? model, String? osVersion)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _DeviceInfo() when $default != null:
        return $default(_that.id, _that.model, _that.osVersion);
      case _:
        return orElse();
    }
  }
...
class _DeviceInfo implements DeviceInfo {
  const _DeviceInfo({required this.id, this.model, this.osVersion});
